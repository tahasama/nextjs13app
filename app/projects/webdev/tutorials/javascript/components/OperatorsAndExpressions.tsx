  ...
  return (
    <div className="mx-auto max-w-[68rem] p-8 indent-10 w-full">
      ...
      >
        ...
        <ul className="list-disc list-inside mb-4 overflow-auto">
          ...
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 == 5; // true`}</pre>
          <li>Not equal to (!=): checks if two values are not equal</li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 != 3; // true`}</pre>
          <li>
            Strict equal to (===): checks if two values are equal and have the
            same type
          </li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 === "5"; // false`}</pre>
          <li>
          ...
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 < 3; // false`}</pre>
          <li>
        ...
        <ul className="list-disc list-inside mb-4 overflow-auto">
          ...
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`(5 > 3) && (10 < 20); // true`}</pre>
          <li>Logical OR (||): returns true if at least one operand is true</li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`(5 > 10) || (3 > 1); // true`}</pre>
    ...
    var canVote = (age >= 18) ? "Yes" : "No"; `}
        ...
        <ul className="list-disc list-inside mb-4 overflow-auto">
          ...
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 + 3; // 8`}</pre>
          <li>Subtraction (-): subtracts the second value from the first</li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 - 3; // 2`}</pre>
          <li>Multiplication (*): multiplies two values</li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`5 * 3; // 15`}</pre>
          <li>Division (/): divides the first value by the second</li>
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`15 / 3; // 5`}</pre>
          ...
          <pre className="bg-gray-800 rounded-md text-white p-2 mb-4 overflow-auto">{`var y = 5;y--; // y becomes 4`}</pre>
        </ul>
        <h3 className="text-lg font-semibold mb-2">
