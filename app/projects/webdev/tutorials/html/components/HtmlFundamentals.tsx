  ...
  return (
    <div className="mx-auto max-w-[68rem] p-8 indent-10 w-full">
      ...
      >
        ...
        <p className="mb-4">
          The <code>&lt;p&gt;</code> tag is used to define a paragraph of text.
          It is a block-level element, which means that it creates a new line
          and a new block of content. Paragraphs are commonly used to group
          together related text content.
        </p>
    ...
    <h1>This is h1 the biggest heading size</h1>
        ...
        <p className="mb-4">
          The <code>&lt;div&gt;</code> tag is used to create a section of
          content that can be styled and positioned independently from the rest
          of the document. It is a container element that is often used to group
          together related content or create layout structures.
        </p>
        <pre className="bg-gray-800 rounded-md text-white p-2 mb-4">
          {`
    <div>This is a div</div>
        ...
        <p className="mb-4">
          ...
          <code>&lt;div&gt;</code> tag in that it is a container element.
          However, the <code>&lt;span&gt;</code> tag is an inline-level element,
          which means that it does not create a new line or a new block of
          content. Instead, it is used to apply styles or manipulate small
          sections of content within a larger block.
        </p>
        <pre className="bg-gray-800 rounded-md text-white p-2 mb-4">
          {`
